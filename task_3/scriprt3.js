...
const sumAllNewPrice = dataList.reduce(
  (prevValue, sum) => (prevValue += sum.price),
  0
)
console.log(`1) Загальну вартіст становить: ${sumAllNewPrice}`)
//==============================================================================================

const disconPrice = dataList.reduce(
  (prevValue, count) => count.price < count.old_price ? prevValue + 1 : prevValue,
  0
)
console.log(
  `2) ${disconPrice} товарів, у яких ціна зменшилась`
)
//==============================================================================================
const statusArr = []
const statusEl = dataList.filter((element) =>{
	if(element.sell_status === 'available')
...
const listProducts = statusArr.map(({ id, price, old_price, usd_price }) => {
